...
<CodeBlocks_project_file>
	...
	<Project>
		<Option title="HWK6_vareye" />
		<Option pch_mode="2" />
		<Option compiler="gcc" />
		<Build>
			<Target title="Debug">
				<Option output="bin/Debug/HWK6_vareye" prefix_auto="1" extension_auto="1" />
				<Option object_output="obj/Debug/" />
				<Option type="1" />
				<Option compiler="gcc" />
				<Compiler>
					<Add option="-g" />
					<Add directory="C:/Users/Erin/workspace/HWK6_vareye/" />
				</Compiler>
			</Target>
			<Target title="Release">
				<Option output="bin/Release/HWK6_vareye" prefix_auto="1" extension_auto="1" />
